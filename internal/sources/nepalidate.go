...
func parseBS(label string) (year, month, day int, err error) {
	if parts := regexp.MustCompile(`^(\d{4})-(\d{1,2})-(\d{1,2})$`).FindStringSubmatch(label); parts != nil {
	...
	months := map[string]int{"baisakh": 1, "baishakh": 1, "baishak": 1, "jestha": 2, "jeth": 2, "ashad": 3, "ashadh": 3, "ashar": 3, "asar": 3, "shrawan": 4, "shravan": 4, "sharwan": 4, "bhadra": 5, "bhadau": 5, "ashwin": 6, "aswin": 6, "ashoj": 6, "asoj": 6, "kartik": 7, "karthik": 7, "mangsir": 8, "mangshir": 8, "mangisr": 8, "poush": 9, "paush": 9, "magh": 10, "falgun": 11, "phalgun": 11, "chaitra": 12, "chait": 12}
